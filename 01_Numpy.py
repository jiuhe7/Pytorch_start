...
# 对数函数
# x=np.array([1,2,4,1024])
# print('inx=',np.log(x))
# print('inx=',np.log2(x))
# print('inx=',np.log10(x))

# 聚合函数
# arr=np.random.random((2,3))
# print(arr)
# print("求维度一(列)最大值： ",np.max(arr,axis=0))
# print("求维度二(行)最大值： ",np.max(arr,axis=1))
# print("求整体最大值： ",np.max(arr))

# # 求和
# print("求维度一(列)和： ",np.sum(arr,axis=0))
# print("求维度二(行)和： ",np.sum(arr,axis=1))
# print("求整体和： ",np.sum(arr))

# 均值函数
# arr=np.arange(10).reshape(2,5)
# print(arr)
# print("求维度一(列)和： ",np.mean(arr,axis=0))
# print("求维度二(行)和： ",np.mean(arr,axis=1))
# print("求整体和： ",np.mean(arr))
...
# print(arr)
# print((arr>4)|(arr>6))
# arr1=np.arange(1,13,2).reshape(2,-1)
# print(arr1)
# print(arr>=arr1)
...
# 求积
# arr=np.arange(0,10).reshape(2,-1)
# print(arr)
# print("求维度一(列)积： ",np.prod(arr,axis=0))
# print("求维度二(行)积： ",np.prod(arr,axis=1))
# print("求整体积： ",np.prod(arr))
...
# 是否有相同元素
# arr=np.arange(1,8)
# arr1=np.flipud(np.arange(1,8))
# print(arr)
# print(arr1)
# print(np.any(arr==arr1))
...
# 布尔型作为掩码
# arr=((np.random.random(10))*100).astype(int)
# print(arr)
# print(arr>50)
# print(arr[arr>50])
#
# arr=((np.random.random(10))*100).astype(int)
# print(arr)
# arr2=((np.random.random(10))*100).astype(int)
# print(arr2)
# print(arr>arr2)
# print(arr[arr>arr2])
# print(arr2[arr>arr2])
